...
if __name__ == '__main__':
    gamestate = open('./maps/map31.txt').read()
    players = ['Simple_Strategic', 'Simple_Strategic']
    window = PlanetWarsWindow(gamestate=gamestate, players=players, max_game_length=500000)
    app.run()
